...
\newpage
\p Citations. Example of usage where the paragraphs are numbered, like in a judgment, and any headings are only navigational aids and not part of the judgment. The first case is also mentioned in \pararef{par:snail}. See para [\ref{para.14}].
