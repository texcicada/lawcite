...
\renewcommand\lcdemolabelw{3.5cm}
...
%\begin{tabular}{ll}
%Cite command & Example\\
%lawcite & \lawcite{snail} \\
%lcnickname & \lcnickname{snail} \\
%\end{tabular}
%\bigskip

%\noindent\makebox[4cm][l]{lawcite}Text\lawcite{snail}
%
%\noindent\makebox[4cm][l]{lcinline}\lcinline{snail}
%
%\noindent\makebox[4cm][l]{lcinlinenn}\lcinlinenn{snail}
%
%\noindent\makebox[4cm][l]{lcfoot}Text\lcfoot{snail}
%
%
%\noindent\makebox[4cm][l]{lcnickname}\lcnickname{snail}
%
%\noindent\makebox[4cm][l]{lawcitetitle}\lawcitetitle{snail}
%
%\noindent\makebox[4cm][l]{lawciteref}\lawciteref{snail}
%
%\noindent\makebox[4cm][l]{lcrefnn}\lcrefnn{snail}
%
%\noindent\makebox[4cm][l]{lcnote}\lcnote{snail}
%
%\noindent\makebox[4cm][l]{lcshorttitle}\lcshorttitle{snail}
%
%\lcsetstyledefault
%
%The \lawcite[\bibstring{section} 192I(f)]{crimnsw}
%
%\lcsetstylemcgill
