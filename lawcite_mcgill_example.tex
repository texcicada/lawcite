...
These cases will appear in the bibliography because they do not have \texttt{options = \{skip-bib = true \},} set in their bibentries and are not otherwise excluded.
...
This cited reference will appear in the bibliography because it does not have \texttt{options = \{skip-bib = true \},} set in its bibentry and is not otherwise excluded.
...
{
AGLC style starts here with \cmd{lcsetstyleaglc} inside a group $\rightarrow$
\lcsetstyleaglc
%\DeclareFieldFormat{postnote}{#1}%

Oz format: short (n X) ppt
...
x\lawcite{capital}
x\lawcite[\nopp 229]{spratt}
}$\leftarrow$ grouping for AGLC style ends here.
