...
@case{lccrestonmoly2014,
  partya = {Creston Moly Corp.\protect\@}, 
  partyb = {Sattva Capital Corp.\protect\@},
...
\newpage
\p Non-McGill material: a Table of Cases (run with SplitIndex, using the square.ist index style file). Note that ToC is for other legal citation styles, and that items appearing in a McGill bibliography (see \pararef{mcgbib}) count as citations for the index tracker.
