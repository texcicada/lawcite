...
\printtext[emph]{\thefield{title}}\iffieldundef{subtitle}{}{\addcolon\addspace\printtext[emph]{subtitle}}%
}%end italic
{%not italic
...
\usepackage{makecell}
%%\usepackage{setspace}%now part of kernel (?)%for line spacing, for \ack
\usepackage{soul}
...
\optsett{\cmd{lccitedemo}\{key(s)\}}{} -- case citation\\
\optsett{\cmd{lccitedemorr}\{key(s)\}}{} -- parallel report case citation\\
\optsett{\cmd{lccitedemostat}\{key\}}{} -- statute citation\\
\optsett{\cmd{lccitedemolj}\{key\}}{} -- law journal citation\\
