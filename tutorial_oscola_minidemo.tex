...
\begin{quotation}
``Adherence to the \textit{Rules of Court} is necessary to ensure a level playing field for all litigants and to provide predictability for all participants.'' -- \cite[20]{pietersma}
\end{quotation}
