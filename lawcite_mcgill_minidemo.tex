...
{ ::getcn } 
{ 
\c{usebibmacro} \cB\{ getcasename \cE\}
} 
\l_myscriptname_tl
...
{ ::geturl } 
{ 
\c{usebibmacro} \cB\{ getcaseurl \cE\}
} 
\l_myscriptname_tl
...
{ ::getref } 
{ 
\c{usebibmacro} \cB\{ getcaseref \cE\}
} 
\l_myscriptname_tl
...
\newpage
\begin{quotation}\noindent
As Woods J.A. said in \highLight{R. v. Perras (1972), 1972 CanLII 868 (SK CA), 8 C.C.C. (2d) 209, at p. 213}, ``The evidence of a physician stating what a patient told him about his symptoms is not evidence as to the existence of the symptoms. To accept it as such would be to infringe the rule against hearsay."\lawcite[45-46]{abbey}
\end{quotation}
