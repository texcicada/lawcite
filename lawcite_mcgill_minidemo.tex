...
%
\newtoggle{partynamesitalictoctos}
\togglefalse{partynamesitalictoctos}
%
...
%
\DeclareBibliographyOption[boolean]{party-names-italic-toctos}[true]{%
\ifstrequal{#1}{true}
{\toggletrue{partynamesitalictoctos}}
{\togglefalse{partynamesitalictoctos}}%
}
%
...
\newbibmacro*{qquotation}{%
  ...
  \iffieldundef{qquotation}
   ...
   \addspace --\lcnbsp\usebibmacro{getcasenamerefnofn}%
  \endgroup}
%	  \tex_Uchar:D 160
%\nobreakspace
%\tl_new:N \c_nbspace_tl
%\tl_set:Nn \c_nbspace_tl { \tex_Uchar:D 160 }
...
\newcommand\setpartynamesitalictoctoson{\settoggle{partynamesitalictoctos}{true}}
\newcommand\setpartynamesitalictoctosoff{\settoggle{partynamesitalictoctos}{false}}
...
\renewcommand\lcindexaccum{}%empty the accumulator
\xappto\lcindexaccum{%[cases] AA
\thefield{title}, \thefield{svjy}%
, c \thefield{chapter}%
}%
%%\iftoggle{lcindexing}{\sindex[\lctor]{\lcindexaccum\lcparnumrefsencap}\renewcommand\lcindexaccum{}}{}%AA
\ifkeyword{regulations}{\toggletrue{printxregulations}}{\togglefalse{printxregulations}}%
\iftoggle{lcindexing}{\sindex[\lctor]{\lcindexaccum\lcparnumrefsencap}\renewcommand\lcindexaccum{}}{}%real
\togglefalse{printxregulations}%
%\renewcommand\lcindexaccum{}%empty
\csxdef{lcindexaccum}{}%empty: global
 }{}%endif
}
...
\NewDocumentCommand  { \lcqquotationmdf } { o m } {
\IfNoValueTF{#1}%
{%
\begin{mdframed}%
\lcqquotation{#2}%
...
{%
\iffieldundef{postnote}{}{\usebibmacro{postnote}}%
\usebibmacro{getann:noter:comm}%
}
...
\newbibmacro{find:toc:tos:tor}{%
\ifentrytype{case}{\lccase}{\ifentrytype{statute}{\iftoggle{printregulations}{\lctor}{\lctos}}{\lcgeneral}}%
}
...
%%  \newunit\newblock
%  \usebibmacro{edition}%
    \printtext{\mkbibparens{\usebibmacro{edition}\addspace\usebibmacro{publisher+location+date}}\iffieldundef{postnote}{}{\addcomma}}
%%  \newunit
...
\newbibmacro{indexcaseparmtoc}{%
\sindex[cases]{%
\thefield{partya}\thefield{partyb}@%for sorting
%partynames = casename
\iftoggle{partynamesitalictoctos}{%start italic
\textit{%
\iffieldundef{shipname}{\thefield{partya}\iffieldundef{partyajur}{}{ (\thefield{partyajur})}%no space, for one party only; space if partyb (before v)
...
\newbibmacro{indexcaseparmtostor}{%
\iftoggle{lcindexing}{%
  \sindex[\iftoggle{printregulations}{\lctor}{\lctos}]{\thefield{statutetitle}\iftoggle{stattycomma}{,}{} \thefield{statutetitleyear}\iftoggle{statjurisdiction}{\iffieldundef{statutejurisdiction}{}{ (\thefield{statutejurisdiction})}}{}%\usebibmacro{getnote}%
\iffieldundef{note}{}{ (\thefield{note})}%
\lcparnumrefsencap}}{}%
}%
\newbibmacro{indexcaseparm}{%
\ifentrytype{case}{\usebibmacro{indexcaseparmtoc}}{\ifentrytype{statute}{\usebibmacro{indexcaseparmtostor}}{}}%
%
}
...
\begin{filecontents*}[overwrite]{french-lawcitemini.lbx}
  \ProvidesFile{french-lawcitemini.lbx}[2019/04/09 french with additions for legal citations]
...
sub-rules = {{Sub-rules}{sub-rr}},
%
atparagraph = {{au paragraph}{au para}},
atparagraphs = {{aux paragraphs}{aux para}},
legaled = {{ed}{ed}},
legalon = {{on}{on}},
possessive = {{'s}}{{'s}},
ibidsupra = {{supra}}{{supra}},
...
\end{document}
   ...
   [1]
    ...
    [125]   Ces observations l’ont amené à dire à son mari qu’il ressemblait au Capitaine Picard de l’émission de télévision « Star Trek ». Tout d’abord, il a lieu de mentionner que le Tribunal n’a pas connaissance judiciaire de la physionomie du Capitaine Picard de l’émission « Star Trek ». Aucune photographie de ce personnage n’a été produite en preuve. Le Tribunal ne tire, par conséquent, aucune conclusion de fait entre ce personnage fictif et le défendeur. Par contre, le Tribunal a constaté que plusieurs des caractéristiques physiques énumérés par le témoin se retrouvent présentes sur le défendeur.

 R. c. Nadeau, 2014 QCCM 48 (CanLII)
 
 R. c. Nadeau, 2014 QCCM 48 (CanLII), <https://canlii.ca/t/g6b3q>,
