...
{
\lcsetstylemcgill
\exampledemo[fsoff]{\lccurrentstyle}{\mkbibquote{\ldots Chief Justice Lamer’s observations in \lcshorttitle{rta1996} where he invoked Lord Sankey’s famous admonition in the 1929 \lcnickname{edwardsa} case \lcinlineparens{edwardsa} that the Constitution is a \mkbibquote{living tree} to be interpreted flexibly\ldots}\lawcite[From][303]{ccpref}}{Canadian style}{can}
}
