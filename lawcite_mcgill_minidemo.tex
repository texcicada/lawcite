...
%  \togglefalse{blx@bibliography}%
  \iffieldundef{noterup}
    {\printfile[annotation]{\bibnoterupprefix\thefield{entrykey}.tex}}
    {\printfield{noterup}}%
  \endgroup}
...
%  \togglefalse{blx@bibliography}%
  \iffieldundef{commentary}
    {\printfile[annotation]{\bibcommentaryprefix\thefield{entrykey}.tex}}
    {\printfield{commentary}}%
  \endgroup}
...
Requires \cmdc{loadfiles=true} Biblatex package option.
\toggletrue{useannotation}
\toggletrue{usenoterup}
\toggletrue{usecommentary}
