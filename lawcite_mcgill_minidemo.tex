...
\citetrackerfalse
\lcsetstyleaglc
\p Components of a citation can be retrieved individually for use as standalone items. For a given citation ``\lcinline[563]{snail}'':
\begin{itemize}
...
\p Statutes may be cited with \democomm[Text]{lawcite}{fla}{:}
...
\p Citation of regulations from some jurisdictions could use \democomm[]{lawcite}{canregnb}{:}
...
\cmd{qcite} (quoted text, with attribution): \begin{quotation}\qcite{q5}\end{quotation}
\cmd{qcitetext} (quoted text): \begin{quotation}\qcitetext{q5}\end{quotation}
\cmd{qcitetextnoqq} (plain text, no quotes): \begin{quotation}\qcitetextnoqq{q5}\end{quotation}
\cmd{qqcite} (formatted epigraph quote): \begin{quotation}\qqcite{q5}\end{quotation}
\cmd{qqcitefn} (formatted epigraph quote with footnote mark, to be used in association with \cmd{footnotetext}): \begin{quotation}\qqcitefn{q5}\end{quotation}\footnotetext{Some text.}
...
\p Switch demo mode on and off with \cmd{lcsetdemoon} and \cmd{lcsetdemooff}, for highlighting citatin components.
...
\p Illustrations of cases, statutes and law journals may be made.
